...
public class TeleporterTestDim extends Teleporter {
	...
	public TeleporterTestDim(WorldServer par1WorldServer) {
			...
			for (int l = -2; l <= 2; ++l) {
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						int i2 = k + i1 * b1 - l * b0;
						boolean flag = j1 < 0;
						this.worldServerInstance.setBlock(k1, l1, i2, flag
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2,
			...
			for (k1 = l - short1; k1 <= l + short1; ++k1) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == Blocks.portalBlock2.blockID) {
							while (this.worldServerInstance.getBlockId(k1,
									i2 - 1, l1) == Blocks.portalBlock2.blockID) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == Blocks.portalBlock2.blockID) {
				j2 = 2;
			}
			...
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == Blocks.portalBlock2.blockID) {
				j2 = 3;
			}
