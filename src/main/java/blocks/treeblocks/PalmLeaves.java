...
public class PalmLeaves extends BlockLeaves implements IShearable
{
	...
	{
		return Blocks.palmSapling.blockID;
	}
			...
			int par4, int par5, float par6, int par7)
	{
		if (!par1World.isRemote)
		{
			...
			if ((par5 & 3) == 0 && par1World.rand.nextInt(j1) <= 15)
			{
				this.dropBlockAsItem_do(par1World, par2, par3, par4,
						new ItemStack(Items.coconut, 1, 0));
			}
		}
	}
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("awid:palmleaves");
	}
