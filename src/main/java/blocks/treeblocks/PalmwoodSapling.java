...
public class PalmwoodSapling extends BlockSapling
{
	public static final String[] WOOD_TYPES = new String[] { "palm" };
	@SideOnly(Side.CLIENT)
	private Icon[] saplingIcon;
	
	public PalmwoodSapling(int par1)
	{
		super(par1);
		float f = 0.4F;
		...
		this.setUnlocalizedName("palmwoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenPalmwoodTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		this.blockIcon = par1IconRegister
				.registerIcon("awid:palmwoodsapling");
	}
}
